...
public class ExcelTools : Editor
{
    ...
    public static string XML_FILE_PATH = Application.dataPath + "/Resources/Config/Xml/";
    public static string CONFIG_DATA_PATH = Application.dataPath + "/Resources/Config/Data/";
    ...
    private static void SerializeHandler(Assembly assembly, DataTable dataTable, string fileName)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            for (int j = 0; j < columns; j++)
            {
                ...
                if(tableValue == "=")
                {
                    Debug.LogError("row:" + i + "col:" + j + "是=号！！！！！");
                }
